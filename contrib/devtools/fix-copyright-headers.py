...
// Copyright (c) 2009-2012 The ChiliCoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The ChiliCoin/$1-%s The ChiliCoin/' %s"
REGEX_CURRENT= re.compile("%s The ChiliCoin" % year)
